...
% input_dir = '/share4/huoy1/RSNA/docker/OUTPUTS/DeepSegResults/results_single/206';
% % set the directory where all of the output information will be stored
% output_dir = '/share4/huoy1/RSNA/docker/OUTPUTS/FinalSeg';

orig_dir = '/OUTPUTS/dicom2nifti';
input_dir = '/OUTPUTS/DeepSegResults/results_single/206';
% set the directory where all of the output information will be stored
output_dir = '/OUTPUTS/FinalSeg';
...
try
    % run the pipeline
    oneviews_into_nifti(orig_dir,input_dir,output_dir);
catch e
    getReport(e)
end
disp('Finish Postrocessing...');
exit
