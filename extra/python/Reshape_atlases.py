...
for key in keys:
    atlas_img_dir = '/fs4/masi/yaoy4/rawdata/resample_rawimg/%s/' % key
    atlas_seg_dir = '/fs4/masi/yaoy4/rawdata/resample_rawlabel/%s/' % key

    output_img_dir = '/home-local/CT_Abo_Deep/Atlases/resample_pythonspace/aladin-reg-images/%s/' % key
    output_seg_dir = '/home-local/CT_Abo_Deep/Atlases/resample_pythonspace/aladin-reg-labels/%s/' % key
